...
const sections = [
  {
    ...
    content: "Autorizas a GOXA a enviarte comunicaciones comerciales relacionadas con sus productos, promociones, descuentos, novedades, beneficios, campañas especiales, lanzamientos, recordatorios de compra, catálogos y ofertas disponibles.\n\nEsta autorización es independiente de la aceptación de los Términos y Condiciones. Puedes usar nuestros canales o solicitar información sin estar obligado/a a aceptar comunicaciones promocionales, salvo aquellas necesarias para atender una consulta o pedido iniciado por ti."
  },
  {
    id: "canales",
